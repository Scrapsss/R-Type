...
{
    explosion1Surface = SDL_LoadBMP("C:/Users/Scrap/Documents/Projet R-Type/R-Type/src/explosion.bmp");
    explosion1Texture = SDL_CreateTextureFromSurface(renderer, explosion1Surface);
    SDL_FreeSurface(explosion1Surface);

    explosion2Surface = SDL_LoadBMP("C:/Users/Scrap/Documents/Projet R-Type/R-Type/src/explosion1.bmp");
    explosion2Texture = SDL_CreateTextureFromSurface(renderer, explosion2Surface);
    SDL_FreeSurface(explosion2Surface);

    explosion3Surface = SDL_LoadBMP("C:/Users/Scrap/Documents/Projet R-Type/R-Type/src/explosion2.bmp");
    explosion3Texture = SDL_CreateTextureFromSurface(renderer, explosion3Surface);
    SDL_FreeSurface(explosion3Surface);

    explosion4Surface = SDL_LoadBMP("C:/Users/Scrap/Documents/Projet R-Type/R-Type/src/explosion3.bmp");
    explosion4Texture = SDL_CreateTextureFromSurface(renderer, explosion4Surface);
    SDL_FreeSurface(explosion4Surface);

    explosion5Surface = SDL_LoadBMP("C:/Users/Scrap/Documents/Projet R-Type/R-Type/src/explosion4.bmp");
...
void TextureGame()
{
    ...
    shipSurface = SDL_LoadBMP("C:/Users/Scrap/Documents/Projet R-Type/R-Type/src/prompto.bmp");
    shipTexture = SDL_CreateTextureFromSurface(renderer, shipSurface);
    SDL_FreeSurface(shipSurface);

    // Ennemi
    ennemiSurface = SDL_LoadBMP("C:/Users/Scrap/Documents/Projet R-Type/R-Type/src/pampa.bmp");
    ennemiTexture = SDL_CreateTextureFromSurface(renderer, ennemiSurface);
    SDL_FreeSurface(ennemiSurface);

    // Terrain
    terrainSurface = SDL_LoadBMP("C:/Users/Scrap/Documents/Projet R-Type/R-Type/src/herbe.bmp");
    terrainTexture = SDL_CreateTextureFromSurface(renderer, terrainSurface);
    SDL_FreeSurface(terrainSurface);

    // Projectiles
    tirSurface = SDL_LoadBMP("C:/Users/Scrap/Documents/Projet R-Type/R-Type/src/bullet.bmp");
    tirTexture = SDL_CreateTextureFromSurface(renderer, tirSurface);
    SDL_FreeSurface(tirSurface);

    // Boutons
    buttonSurface = SDL_LoadBMP("C:/Users/Scrap/Documents/Projet R-Type/R-Type/src/button.bmp");
    buttonTexture = SDL_CreateTextureFromSurface(renderer, buttonSurface);
    SDL_FreeSurface(buttonSurface);

    // logo
    logoSurface = SDL_LoadBMP("C:/Users/Scrap/Documents/Projet R-Type/R-Type/src/logo.bmp");
